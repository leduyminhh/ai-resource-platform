...
- [ ] **Step 1: Viết ADR-0003** với nội dung:
...
- [ ] **Step 1: Viết script** (bash thuần, POSIX-ish; chạy được trên Git Bash Windows):
...
- [ ] **Step 2: Chạy script trên trạng thái HIỆN TẠI (kỳ vọng FAIL)**
...
- [ ] **Step 1: Đối chiếu hiện trạng repo trước khi viết**
...
- [ ] **Step 2: Thay toàn bộ file** bằng (chỉnh lại nếu Step 1 lệch):
...
- [ ] **Step 1: Thêm mục forward-ref pending vào `TODO.md`** (append, giữ nội dung cũ):
...
- [ ] **Step 2: Kiểm tra SUMMARY.md vẫn đủ 5 RFC overview**
...
- [ ] **Step 3: Chạy verify toàn cụm (kỳ vọng PASS)**
